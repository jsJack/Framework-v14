/**
 * Use !button in VS Code to paste this template
 */

const { ButtonInteraction, EmbedBuilder, MessageFlags, PermissionFlagsBits } = require('discord.js');
