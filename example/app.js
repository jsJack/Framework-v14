/**
 * Use !app in VS Code to paste this template
 */

const { ContextMenuCommandBuilder, ApplicationCommandType, ContextMenuCommandInteraction, EmbedBuilder, MessageFlags, PermissionFlagsBits } = require('discord.js');
...
module.exports = {
    // The constructor for the contect menu
    data: new ContextMenuCommandBuilder()
       .setType(ApplicationCommandType.User) // Run on right-clicking a user
       .setName("Application Command"),
       // Lots of other options in the builder but these are the bare minimum
